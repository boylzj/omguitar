...
<div class="content">
	...
	<h3 class="product_title fwb"><?php echo $title;?></h3>
	<div class="clearfix pt20 pb30 product_header">
		<div class="fl product_pic"><img src="<?php echo thumb($thumb,230,230);?>" alt="blues" /></div>
		<div class="fl pl50 product_detail_r">
			<p class="f14"><span class="gray_color">作曲：</span><span class="fwb"><?php echo $author;?></span></p>
			<p class="pt5 f14"><span class="gray_color">歌手：</span><span class="fwb"><?php echo $singer;?></span></p>
			<p class="pt30 f14 dark_word_color pb15"><?php echo $description;?></p>
	...
	<div class="product_box pt30 clearfix">
		<div class="product_b_l">
			...
			<div class="video_tool">
				<div class="join_number clearfix">
					...
					<i title="难度" class="level fr"><img src="<?php echo IMG_PATH;?>guitar/level_3.png" alt="" class="fl"></i>
				</div>
			</div>
			<div class="giutar_pro pt30">
				<?php $n=1;if(is_array($guitar_tap)) foreach($guitar_tap AS $r) { ?>
				  <img alt="<?php echo $r['alt'];?>" src="<?php echo $r['url'];?>" />
				<?php $n++;}unset($n); ?>
			</div>
		...
		<div class="product_b_r">
			...
			<div class="p_th_avatar"><a href="#"><img src="<?php echo get_memberavatar($ssouid,48,45);?>"></a></div><a href="teather_detail.html" class="p_th_name"><?php echo $meminfo['nickname'];?></a>
		<?php
	        if(isset($ssouid)){
		...
		?>
			<p class="pt15 f14 dark_word_color clear pb30 p_th_des"><?php echo $m_more['person_info'];?></p>
